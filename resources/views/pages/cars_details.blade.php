...
<h3 style="font-family: sans-serif;">{{$car->name}}</h3>

<h3 style="font-family: cursive;">ORIGINAL PRICE: ${{$car->original_price}}</h3> <h3 style="font-family: cursive;">SELLING PRICE: ${{$car->selling_price}}</h3>
ABOUT PRODUCT
<h5 style="font-family: sans-serif;">{{$car->description}}</h5>
</div>
<br>
<br>
