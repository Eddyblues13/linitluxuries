...
<img alt="image" itemprop="image" src="{{asset($image->image) }}" />
@endforeach
...
<h3 style="font-family: sans-serif;">{{$country->name}}</h3>

<h3 style="font-family: cursive;">ORIGINAL PRICE: ${{$country->original_price}}</h3> <h3 style="font-family: cursive;">SELLING PRICE: ${{$country->selling_price}}</h3>
ABOUT PRODUCT
<h5 style="font-family: sans-serif;">{{$country->description}}</h5>
</div>
<br>
<br>
