...
<a itemprop="item" href="/for-rent"><span itemprop='name'>Rentals</span>
</a></li>
...
<div class='col-md-9'>
<h1 class='city-page-heading'>Homes in United States - see all vacant Apartments in United States here</h1>
</div>
...
<a href="{{ url('/house-details/'.$count->house->slug).'/'.$count->slug }}"><div class='swiper-container'>
<div class='swiper-wrapper'>
<div class='swiper-slide'>
<img class='property-image lazyload' data-image-id='61159897' width="500" height="200" data-src="{{asset($count->countryImages[0]->image)}}"  onerror='imageLoadFailed(this)' src="{{asset($count->countryImages[0]->image)}}">
</div>
<div class='swiper-slide'>
...
<b>{{ $count->selling_price }} $</b>
</div>
<a class="see-more fake-btn" href="/listings/appartement-a-louer-paris-54f7cc">Read more</a>
</div>
</div>
<script>
